...
public class Empleados {
    ...
    public String toString() {
        return "Empleados{" + "empleadoId=" + empleadoId + ", nombreEmpleado=" + nombreEmpleado + ", apellidoEmpleado=" + apellidoEmpleado + ", sueldo=" + sueldo + ", horaEntrada=" + horaEntrada + ", horaSalida=" + horaSalida + ", cargoId=" + cargoId + ", cargo=" + cargo + ", encargadoId=" + encargadoId + ", encargado=" + encargado + '}';
    }
