...
public class FormClienteController implements Initializable {
    ...
    @FXML
    TextField tfCliente, tfNombre, tfApellido, tfTelefono,tfDireccion, tfNit;
    ...
    public void cargarDatos(Cliente cliente){
        tfCliente.setText(Integer.toString(cliente.getClienteId()));
    ...
    try{
           ...
           statement = conexion.prepareStatement(sql);
           statement.setInt(1, Integer.parseInt(tfCliente.getText()));
